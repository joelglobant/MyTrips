...
import com.glob.mytrips.domain.providers.StateProvider
...
class StateDataProvider(
    ...
    override fun getStateByIdUseCase(): SingleUseCase<GetStateByIdUseCase.Params, StateDto> {
        return GetStateByIdUseCase(stateRepository, threadExecutor, postExecutorThread)
    }

    override fun getStatesByUserUseCase(): SingleUseCase<GetStatesByCountryUseCase.Params, List<StateDto>> {
